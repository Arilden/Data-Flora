...
Contexto para agentes de IA (Claude, Copilot, Cursor, ou qualquer outro) trabalhando neste
repositório.
...
- A extração de dados é feita localmente, no computador da usuária — os scripts em `scripts/`
  dependem de rede irrestrita para acessar data.rio, arcgis.com e ftp.ibge.gov.br.
